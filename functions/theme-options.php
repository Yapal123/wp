...
//Основные        
      ...
      array(
        'id'          => 'logo_upload',
        'label'       => 'Загрузка картинки для логотипа',
        'desc'        => 'Загрузите картинку для логотипа',
        'type'        => 'upload',
        'section'     => 'Header',
      ),
    //Включение выключение описания
      array(
        'id'          => 'desc_on_off',
        'label'       => 'Включить/выключить описание на сайте',
...
//Контакты и время
      ...
      array(
        ...
        'desc'        => 'Актуальный номер телефона в шапке сайта',
        'type'        => 'text',
        'section'     => 'Header',
      ),
      //Время работы
